...
/*--------------------------------------------------------------------------------------
 Copyright 2015 Dialog Direct All Rights Reserved
 Name       :  CIM_Promo_Variance_Report_Vw
 Author-Date:  Angela Plafcan - 11/24/2015
 Description:  This view is used to compare the recency of objects between dev and prod
                  as part of the deployment process.  The view will compare objects
                  that exist in both dev and prod and determine if they have the same
                  update date, or if one is older or newer than the other.
                  
                  Any objects that do not have the same update date for the particualr
                  client in which a process is being deployed, should be investigated
                  prior to deploying.
 ---------------------------------------------------------------------------------------
 Modified:   
 ...
 ---------- ------------ --------- -----------------------------------------------------
 11/24/2015 APlafcan               Created with the support of Marc Hall (Teradata).                                      
--------------------------------------------------------------------------------------*/
if object_id('CIM_Promo_Variance_Report_Vw') is not null drop view [CIM_Promo_Variance_Report_Vw]
go 

create view [CIM_Promo_Variance_Report_Vw] as 
select main.*
